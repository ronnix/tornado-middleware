...
from tornado_middleware.decorators import callback_engine


class CallbackGenTest(AsyncTestCase):
    def run_gen(self, f):
        f()
        self.wait()
    ...
    def test_exception_in_task_phase2(self):
        # This is the case that requires the use of stack_context in callback_engine
        def fail_task(callback):
